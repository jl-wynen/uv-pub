...
pub static GITHUB_RATE_LIMIT_STATUS: GitHubRateLimitStatus = GitHubRateLimitStatus::new();
...
#[derive(Debug)]
pub struct GitHubRateLimitStatus(AtomicBool);
...
pub fn is_github_rate_limited(response: &Response) -> bool {
